...
var appKozmikCareSystem = angular.module('appKozmikCareSystem', ['ngRoute', 'ngCookies', 'angularUtils.directives.dirPagination', 'angular-loading-bar']);

appKozmikCareSystem.run(function ($rootScope, $cookies, $http) {
    ...
    $rootScope.ServiceUrl = "http://localhost:61811/api/";

});

//appKozmikCareSystem.config(['$locationProvider', function ($locationProvider) {
//    $locationProvider.hashPrefix('');
//}]);

appKozmikCareSystem.config(function ($routeProvider, $httpProvider) {
...
appKozmikCareSystem.directive('fileModel', function ($parse) {
    return {
        restrict: 'A',
...
appKozmikCareSystem.factory("utilityService", function ($http) {
    utilityObj = {};
...
appKozmikCareSystem.controller('appKozmikCareSystemController', function ($scope, $rootScope, $location, $cookies, utilityService) {
